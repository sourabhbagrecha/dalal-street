...
Monopoly Deal Rules for Property & Property Wildcards
-----------------------------------------------------

The **Monopoly Deal Rules** for Property & Property Wildcards section contains a list of _Rules_ and _frequently asked questions_ pertaining to how property and Property Wildcards can be used, taken, and organized. Topics range from _"Can a property wildcard be taken from you"_ to _"can property cards be moved to different sets once played"_. The official Monopoly Rules are used to answer as many of the questions as possible. If the official rules are not known for that question then the generally accepted answer is used.
