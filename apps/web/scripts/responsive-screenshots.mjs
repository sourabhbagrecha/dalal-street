// Dev-only tool: captures the /local game screen (seeded with the
// `responsiveMidGame` fixture) at a fixed set of viewports for manual
// responsive-layout review. Run: node apps/web/scripts/responsive-screenshots.mjs
...
const OUT_DIR = join(__dirname, '..', '..', '..', 'responsive-screenshots');
